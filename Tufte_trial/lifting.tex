...
\begin{definition}[filtered poset]
  ...
  A poset $(I, \leq)$ is called \defn{filtered} (or \emph{$\aleph_{0}$-filtered}) if every finite subset of $I$ has an upper bound. 

  More generally, the poset $(I, \leq)$ is \defn{$\kappa$-filtered}, for some regular cardinal $\kappa$, if every subset of $I$ cardinality less than $\kappa$ has an upper bound.
\end{definition}
...
\begin{proof}
  ...
  \begin{equation}
    ...
    \mathcal{C}(X, Y_{\infty}) \cong \mathcal{C}(X, \colim_{i \in I} Y_{i}) \cong \colim_{i \in I}\mathcal{C}(X, Y_{i}).
  \end{equation}
